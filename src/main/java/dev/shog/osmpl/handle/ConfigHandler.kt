...
internal object ConfigHandler {
    private val requiredKeys = setOf("discordLink", "playerDeath", "discordMessage", "sleepComplete", "sleepPart", "enableSlowModeAt", "slowModeInSec", "rafflePrice", "slowModeDisableUnderThreshold", "ipHubKey", "webhook", "username", "password", "url")
